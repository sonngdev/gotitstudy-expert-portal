				...
				(haxe.Md5.prototype = {
					...
					str2blks: function(e) {
						...
						for (var r = 0; r < e.length; )
							(n[r >> 2] |= HxOverrides.cca(e, r) << (((8 * e.length + r) % 4) * 8)), r++;
						...
						default:
							return (
								...
								((t == Class && null != e.__name__) ||
									((t == Enum && null != e.__ename__) || e.__enum__ == t))
							);
					}
				}),
						...
						switch (e.length) {
							case 8:
								var t = e.split(':'),
									n = new Date();
								return (
									n.setTime(0), n.setUTCHours(t[0]), n.setUTCMinutes(t[1]), n.setUTCSeconds(t[2]), n
								);
							case 10:
								t = e.split('-');
								return new Date(t[0], t[1] - 1, t[2], 0, 0, 0);
	...
	function(e, t, n) {
				...
				(function(e, t, n) {
					...
					},
					{
						...
						value: function(e) {
							...
							e = (e = (e = (e = (e = e.split(t).join(o.xmlCharacters.tagOpener))
								.split(n)
					...
					},
					{
						...
						value: function(e) {
							...
							return (e = (e = (e = (e = (e = e.split(t).join(o.safeXmlCharacters.tagOpener))
								.split(n)
								.join(o.safeXmlCharacters.tagCloser))
								.split(i)
								.join(o.safeXmlCharacters.doubleQuote))
						...
						value: function(e, t) {
							...
							if (0 === i) {
								...
								if (-1 === e.indexOf('class'))
									return (
										(n = ''.concat(e.substr(i, o), ' class="wrs_').concat(t, '">')),
					...
					},
					{
						...
						value: function(e) {
							...
							if (-1 !== n) {
								...
								-1 !== i &&
									(t = e.substring(0, n) + e.substring(n + '<semantics>'.length, i) + '</math>');
							}
							return t;
						}
					},
					...
					},
					{
						...
						value: function(e) {
							return -1 !== e.indexOf('.php')
								...
								: -1 !== e.indexOf('.aspx')
									? 'aspx'
									: -1 !== e.indexOf('wirispluginengine') ? 'ruby' : 'java';
						}
					},
					{
					...
					},
					{
						...
						value: function() {
							return -1 !== e.parameters.server.indexOf('php')
								? '.php'
								: -1 !== e.parameters.server.indexOf('aspx') ? '.aspx' : '';
						}
					},
					{
						key: 'listeners',
				...
				(function(e, t, n) {
						...
						value: function(t, n) {
							for (
								...
								if (
									...
									n === o.safeXmlCharacters && (f = a.safeXmlDecode(f)),
										(l += '$$'.concat(f, '$$')),
										e.cache.populate(f, i);
								} else l += i;
								m = t.indexOf(c, g);
							}
					...
					},
					{
						...
						value: function(e, t, n) {
							...
							for (var i, o = e; o.previousSibling && 3 === o.previousSibling.nodeType; )
								o = o.previousSibling;
							function r(e, t, i) {
							...
							var s,
								...
								c = n.open.length;
							do {
								if (null == (i = r(l.node, l.position, n.open)) || a(e, t, i.node, i.position))
									return null;
				...
				})(e, null, [
					{
						...
						value: function(e) {
							...
							return (
								...
								e in this.strings[t]
									? this.strings[t][e]
									: (console.warn('Unknown key '.concat(e, ' in StringManager.')), e)
							);
						}
					}
				]),
			...
			return (
				(function(e, t, n) {
					...
					},
					{
						key: 'removeClass',
						value: function(e, t) {
							for (var n = '', i = e.className.split(' '), o = 0; o < i.length; o += 1)
								i[o] !== t && (n += ''.concat(i[o], ' '));
							e.className = n.trim();
						}
					},
									...
									if (i.getAttribute && 'WirisParam' === i.getAttribute('wirisObject')) {
										for (var o = {}, r = 0; r < i.attributes.length; r += 1)
											null !== i.attributes[r].nodeValue &&
												(o[i.attributes[r].nodeName] = i.attributes[r].nodeValue);
					...
					},
					{
						...
						value: function(e, t) {
							var n = '';
							return (
								e.indexOf('/') !== e.length && 0 !== t.indexOf('/') && (n = '/'),
								(e + n + t).replace(/([^:]\/)\/+/g, '$1')
							);
						}
					},
						...
						value: function(t) {
							...
							return (
								Object.keys(t).forEach(function(i) {
									null != t[i] &&
										(n += ''.concat(e.urlEncode(i), '=').concat(e.urlEncode(t[i]), '&'));
								}),
							...
							if (
								...
								if (r.parentElement) {
									if (r.htmlText.length > 0)
										return 0 === r.text.length ? e.getSelectedItem(t, n, !0) : null;
					...
					},
					{
						...
						value: function(e, t, n) {
							...
							for (var o = e.indexOf('<'.concat(t, ' ')); -1 !== o; ) {
								...
								r = n ? '>' : '</'.concat(t, '>');
								var a = e.indexOf(r, o);
								-1 !== a ? ((a += r.length), i.push({ start: o, end: a })) : (a = o + 1),
					...
					},
					{
						...
						value: function(t, n) {
							...
							for (
								o =
									n ||
									((r = '=' === t.charAt(t.length - 2) ? 2 : '=' === t.charAt(t.length - 1) ? 1 : 0) >
									0
										? t.length - 4
										: t.length),
									a = 0;
							...
							return (
								r &&
									(2 === r
										? ((i = (e.decode64(t.charAt(a)) << 2) | (e.decode64(t.charAt(a + 1)) >> 4)),
											s.push(255 & i))
										: 1 === r &&
											((i =
							...
							if (
								...
								r.setAttribute(l.get('imageMathmlAttribute'), a.safeXmlEncode(n)),
									...
									A.setImgSize(
										r,
										u,
										'base64' === l.get('saveMode') && 'default' === l.get('base64savemode')
									),
								...
								'png' === (d = d.result).format
									...
									l.get('enableAccessibility') &&
										(void 0 === d.alt ? (r.alt = M.mathMLToAccessible(n, o, s)) : (r.alt = d.alt));
							}
									...
									if (-1 !== r.indexOf(' class="'.concat(l.get('imageClassName'), '"'))) {
										...
										if ((-1 === c && ((s = ' alt="'), (c = r.indexOf(s))), -1 !== c)) {
											...
											if (-1 !== h) {
												...
												(e = e.substring(0, t[o].start + i) + f + e.substring(t[o].end + i)),
													(i += f.length - (t[o].end - t[o].start));
											}
										}
									}
								}
							...
							(n.href = t),
								...
								(t =
									'80' === n.port || '443' === n.port
										? ''.concat(n.protocol, '//').concat(n.hostname, '/').concat(n.pathname)
										: ''
												.concat(n.protocol, '//')
												.concat(n.hostname, ':')
												.concat(n.port, '/')
		...
		var D = (function() {
			function e(t) {
				...
				(this.cancelButton = this.createButton(a, this.cancelAction.bind(this))),
					...
					},
					{
						...
						value: function() {
							void 0 === this.contentManager.hasChanges
								? this.close()
								: this.contentManager.hasChanges() ? this.showPopUpMessage() : this.close();
						}
					},
					{
					...
					},
					{
						...
						value: function() {
							this.maximizeDiv.addEventListener('click', this.maximize.bind(this), !0),
								...
								y.addEvent(this.container, 'keydown', this.onKeyDown.bind(this));
						}
					},
					{
						key: 'removeListeners',
					...
					[
							...
							value: function(e, t, n, i) {
								...
								if (n)
									if ('latex' === this.editMode) {
										...
										(o.node = E.mathmlToImgObject(t.document, n, i, this.language)),
											this.insertElementOnSelection(o.node, e, t);
							...
							value: function(e, t, n) {
								if (this.editionProperties.isNewElement)
									...
									e && 'img' === e.nodeName.toLowerCase()
										? (A.removeImgDataAttributes(this.editionProperties.temporalImage),
						...
						},
						{
							...
							value: function(e, t) {
												...
												if (c) {
													...
													if ('textarea' !== e.tagName.toLowerCase())
														if (document.selection) {
															for (var m = 0, g = c.startNode.previousSibling; g; )
																(m += y.getNodeLength(g)), (g = g.previousSibling);
								...
								for (
									var f = l.get('editorAttributes').split(', '), _ = {}, v = 0, b = f.length;
									v < b;
									v += 1
								) {
									var w = f[v].split('='),
						...
						value: function() {
							...
							this.getCore().addListener(o),
								...
								(this.editorObject.settings.images_dataimg_filter = function(t) {
									...
									-1 != t.getAttribute('class').indexOf(l.get('imageClassName'))
					...
					},
					{
						...
						value: function(e) {
							void 0 !== this.editorObject.fire &&
								this.editorObject.fire('ExecCommand', { command: 'updateFormula', value: e }),
		...
		tinymce.create('tinymce.plugins.tiny_mce_wiris', {
			init: function(e, t) {
				...
				(n.serviceProviderProperties.URI = 'https://www.wiris.net/demo/plugins/app'),
					...
					(n.version = '7.17.0.1427'),
					(n.isMoodle = !1),
					void 0 !== e.getParam('wiriscontextpath') &&
						((n.configurationService = y.concatenateUrl(
					...
					void 0 !== e.getParam('mathTypeParameters') &&
						(n.integrationParameters = e.getParam('mathTypeParameters')),
										...
										Array.prototype.forEach.call(
											...
											function(e, t) {
												1 == t.nodeType &&
													Array.prototype.forEach.call(
														t.querySelectorAll(
															'.'.concat(WirisPlugin.Configuration.get('imageClassName'))
														),
														function(e, t) {
				...
				if (
					...
					'onBeforeSetContent' in e
						? e.onBeforeSetContent.add(function(t, n) {
								WirisPlugin.instances[e.id].initParsed &&
									(n.content = E.initParse(n.content, e.getParam('language')));
							})
					...
					(s = e.ui.registry).addIcon(
						...
						s.addMenuItem('tiny_mce_wiris_formulaEditor', {
							text: 'MathType',
							icon: 'mathtypeicon',
							onAction: u
						});
